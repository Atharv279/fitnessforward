        ...
        <Card className="w-full shadow-lg border-0 bg-gradient-to-br from-primary/5 via-background to-background">
          <CardHeader className="flex flex-col items-center text-center space-y-3">
            ...
            <p className="text-lg text-muted-foreground max-w-lg">
              Log your workouts and track your total calories burned.
            </p>
          </CardHeader>
          <CardContent>
            ...
            {entries.length > 0 && (
              <div className="mt-8 space-y-4">
                <div className="p-6 rounded-xl bg-blue-50 border border-blue-200 text-center">
                  <h3 className="text-2xl font-bold">Workout Log</h3>
                  <ul className="list-disc pl-4 mt-2 text-left">
                    {entries.map((e, i) => (
                      <li key={i}>{e.activity} - {e.duration} min - {e.calories} kcal</li>
                    ))}
                  </ul>
                  <div className="mt-4">
        ...
        <Card className="w-full shadow-lg">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Tracking your workouts helps you stay motivated and see your progress over time. Use this simple tracker to log your activities and calories burned each day.
            </p>
          ...
          <CardFooter className="bg-secondary/30 rounded-b-lg">
            <p className="text-sm text-muted-foreground text-center w-full">
              This tracker is for informational purposes only. For personalized fitness advice, consult a professional.
            </p>
          </CardFooter>
        </Card>
      </div>
