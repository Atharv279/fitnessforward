        ...
        <Card className="w-full shadow-lg">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Your daily caloric needs depend on your basal metabolic rate (BMR) and your activity level. This calculator uses the Mifflin-St Jeor Equation, which is widely regarded as one of the most accurate for estimating daily calorie requirements.
            </p>
