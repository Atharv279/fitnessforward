...
const investmentFormSchema = z.object({
  ...
  investmentPeriod: z.coerce.number().min(1, "training period must be at least 1 year."),
...
export function InvestmentCalculatorForm() {
  ...
  return (
    <div className="space-y-6">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 p-1">
          ...
          <div className="flex space-x-4 pt-4">
            <Button type="submit" className="flex-1">Calculate training</Button>
      ...
      {results && (
        <>
          <ResultsDisplay results={resultItems} title={`training Growth (${selectedCurrency})`} />
