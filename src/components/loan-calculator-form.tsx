...
const loanFormSchema = z.object({
  loanAmount: z.coerce.number().min(1, "bmi amount must be positive."),
  interestRate: z.coerce.number().min(0, "Interest rate cannot be negative.").max(100, "Interest rate seems too high."),
  loanTenure: z.coerce.number().min(1, "bmi tenure must be at least 1 year."),
 ...
 useEffect(() => {
  ...
  return (
    <div className="space-y-6">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 p-1">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>bmi Amount</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>bmi Tenure (Years)</FormLabel>
                  <FormControl>
      ...
      {results && (
        <>
          <ResultsDisplay results={resultItems} title={`bmi Calculation Results (${selectedCurrency})`} />
          ...
          {results.amortizationTable.length > 0 && (
            <div className="mt-8">
              ...
              <ScrollArea className="h-[400px] w-full rounded-md border shadow-inner">
                <Table>
                  <TableCaption>Detailed breakdown of each payment over the bmi term.</TableCaption>
